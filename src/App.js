    ...
    <div className="app-container">
      ...
      <main>
        ...
        <Carousel id="pictures" className="carousel">
          <Carousel.Item>
            <img className="d-block w-100 carousel-img" src={img} alt="Lawn care 1" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100 carousel-img" src={img1} alt="Lawn care 2" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100 carousel-img" src={img2} alt="Lawn care 3" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100 carousel-img" src={img3} alt="Lawn care 4" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100 carousel-img" src={img4} alt="Lawn care 5" />
            <Carousel.Caption>
              <h3>Weed Control</h3>
